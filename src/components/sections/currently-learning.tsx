...
export function CurrentlyLearning() {
  return (
    <section className="container-shell pb-[clamp(4.75rem,9vw,8rem)]">
      <div className="grid gap-8 rounded-xl bg-[var(--cobalt-panel)] p-7 text-white sm:p-10 lg:grid-cols-[0.8fr_1.2fr] lg:p-14">
        <div>
        ...
        <div>
          ...
          <div className="mt-7 grid grid-cols-2 gap-px overflow-hidden rounded-lg bg-white/25 sm:grid-cols-3">
            {currentlyExploring.map((item) => (
              <span key={item} className="flex items-center justify-between bg-[var(--cobalt-panel)] px-4 py-3 font-[family-name:var(--font-mono)] text-sm">
